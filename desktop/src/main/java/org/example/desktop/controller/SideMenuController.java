...
public class SideMenuController {
    ...
    public void irMenuPrincipal(ActionEvent actionEvent) {
        StageManager.loadScene("/org/example/desktop/menu-view.fxml", 1200, 800);
    }
    ...
    public void irProveedores(ActionEvent actionEvent){
        StageManager.loadScene("/org/example/desktop/proveedores-view.fxml", 1200, 800);
    }

    public void irUsuarios(ActionEvent actionEvent){
        StageManager.loadScene("/org/example/desktop/usuarios-view.fxml", 1200, 800);
    }
